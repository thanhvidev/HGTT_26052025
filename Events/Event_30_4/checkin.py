...
class Checkin(commands.Cog):
    ...
    @commands.hybrid_command(name='vn', aliases=["VN", "Vn", "vietnam", "VIETNAM", "Vietnam"], description="")
    ...
    @commands.command(aliases=["RSXU", "Rsxu"], description="reset xu event")
    @commands.cooldown(1, 2, commands.BucketType.user)
    @is_guild_owner_or_bot_owner()
    ...
    @commands.command(aliases=["SETXU", "Setxu"], description="set xu event cho người khác")
    @commands.cooldown(1, 2, commands.BucketType.user)
    @is_guild_owner_or_bot_owner()
