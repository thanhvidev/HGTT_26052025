...
class Valentine2025(commands.Cog):
    ...
    @commands.hybrid_command(name='qua', aliases=["QUA", "  Qua"], description="Quay quà tặng")
    ...
    @commands.command(aliases=["RSXUVLT", "Rsxuvlt"], description="reset xu valentine")
    @commands.cooldown(1, 2, commands.BucketType.user)
    @is_guild_owner_or_bot_owner()
    ...
    @commands.command(aliases=["SETXUVLT", "Setxuvlt"], description="set xu love cho người khác")
    @commands.cooldown(1, 2, commands.BucketType.user)
    @is_guild_owner_or_bot_owner()
    ...
    @commands.command(aliases=["SETDIEMVLT", "Setdiemvlt"], description="set điểm valentine cho người khác")
    @commands.cooldown(1, 2, commands.BucketType.user)
    @is_guild_owner_or_bot_owner()
