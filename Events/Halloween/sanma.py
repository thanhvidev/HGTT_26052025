...
class Sanma(commands.Cog):
    ...
    @commands.hybrid_command(name='sanma', aliases=["SANMA", "Sanma"], description="Mở hộp halloween", help="Mở hộp halloween")
    ...
    @commands.command(aliases=["SETXU", "Setxu"], description="set xu cho người khác")
