...
class EventFish(commands.Cog):
    ...
    @commands.command(alises=['CAUCA', 'Cauca'])
    ...
    @commands.command(alises=['Khoca', 'KHOCA'])
    ...
    @commands.command(aliases=["zsetkc", "SETKC"], description="set coin kim cương cho người khác")
