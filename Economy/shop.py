...
class Shop(commands.Cog):
    ...
    @commands.command(aliases=["SHOP", "Shop"], description="cửa hàng")
    ...
    @commands.command(aliases=["BUY","Buy"], description="Mua nhẫn từ cửa hàng")
    ...
    @commands.command(aliases=["QUA", "Qua"], description="Sử dụng quà tặng")
