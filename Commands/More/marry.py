...
class Marry(commands.Cog):
    ...
    @commands.command(aliases=['MARRY', 'Marry'], description="Kết hôn với người nào đó bằng nhẫn hoặc hiển thị thông tin kết hôn của bạn")
    ...
    @commands.command(aliases=['Setmarry', 'SETMARRY'],description="setup hình ảnh marry")
    @is_allowed_channel_checkmarry()
    @set_marry()
    ...
    @commands.command(aliases=['DIVORCE', 'Divorce'], description="Ly hôn với người bạn đã kết hôn")
    @is_allowed_channel_checkmarry()
    @commands.cooldown(1, 15, commands.BucketType.user)
    ...
    @commands.command(aliases=['LOVE', 'Love'], description="Tăng điểm love_marry cho bạn và đối tác")
    ...
    @commands.command(aliases=['up', 'UP'],description="Nâng cấp nhẫn cưới")
    @is_allowed_channel_checkmarry()
    ...
    @commands.command(aliases=['SETLOVE', 'Setlove'],description="Nâng cấp điểm love")
