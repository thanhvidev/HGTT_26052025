...
class Toggle(commands.Cog):  
    ...
    @commands.command(aliases=["ENABLE", "Enable"], description="Enable a command", help="Enable a command")
    ...
    @commands.command(aliases=["DISABLE", "Disable"], description="Disable a command", help="Disable a command") 
    @commands.cooldown(1, 2, commands.BucketType.user)   
    @is_guild_owner_or_bot_owner()  
