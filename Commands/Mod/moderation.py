...
class Moderation(commands.Cog):
    ...
    @commands.hybrid_command(name="khen", aliases=['KHEN', 'Khen'], description="khen thành viên")
    ...
    @commands.hybrid_command(name="ban", aliases=['BAN', 'Ban'], description="ban giả")
    ...
    @commands.hybrid_command(name="mute", aliases=['MUTE', 'Mute'], description="mute giả")
    ...
    @commands.hybrid_command(name="kick", aliases=['KICK', 'Kick'], description="kick giả")
    ...
    @commands.hybrid_command(name="warn", aliases=['WARN', 'Warn'], description="warn giả")
